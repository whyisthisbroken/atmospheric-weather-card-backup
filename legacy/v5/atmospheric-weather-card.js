(function () {
  ...
  const SKY_HEX = {
    sunny: {
      day: ["#B0E8FF", "#60B8FF", "#4098F0", "#3888E0"],
      night: ["#2E2480", "#0F1247", "#05081F", "#000108"],
    },
    "clear-night": {
      day: ["#B0E0FF", "#80B8F0", "#6098D8", "#5080C8"],
      night: ["#264080", "#262947", "#0D0F1F", "#030408"],
    },
    partlycloudy: {
      day: ["#B0E0FF", "#80B8F0", "#6098D8", "#5080C8"],
      night: ["#404D80", "#0D1433", "#030514", "#000004"],
    },
    cloudy: {
      day: ["#EDF7FB", "#B9D5F1", "#96BBDD", "#8DA9D5"],
      night: ["#264080", "#262947", "#0D0F1F", "#030408"],
    },
    windy: {
      day: ["#ECF7FE", "#C5DDF5", "#96B9E0", "#7FA0D1"],
      night: ["#1A3359", "#0D1A40", "#050D26", "#000314"],
    },
    "windy-variant": {
      day: ["#ECF7FE", "#C5DDF5", "#96B9E0", "#7FA0D1"],
      night: ["#1A3359", "#0D1A40", "#050D26", "#000314"],
    ...
    exceptional: {
      day: ["#B0ECFF", "#60C0FF", "#40A0F0", "#3890E0"],
      night: ["#33758F", "#1A3D80", "#1A1457", "#05051A"],
    },
    default: {
      day: ["#A8E4FF", "#70B8F0", "#4898E0", "#3888D0"],
      night: ["#2D2474", "#101141", "#06081D", "#000107"],
    },
    fog: {
      day: ["#E0F0F4", "#C2D8E2", "#A2B6C6", "#8493A6"],
      night: ["#323F53", "#141E35", "#06080F", "#010204"],
    },
    snowy: {
      day: ["#EDF4FC", "#CADCF2", "#AAC6E6", "#93B2D6"],
      night: ["#1C374E", "#0F1E33", "#080F20", "#040812"],
    },
    "snowy-rainy": {
      day: ["#E6EDF7", "#C0D4EC", "#A2BEDC", "#8AAAC9"],
      night: ["#1C374E", "#0F1E33", "#080F20", "#040812"],
    },
    hail: {
      day: ["#7A94B8", "#94B8D6", "#B3DBED", "#D6F2FA"],
      night: ["#263541", "#0F1932", "#080920", "#01030A"],
    },
    rainy: {
      day: ["#D7E7F0", "#A6C2D6", "#5E7E9C", "#39506E"],
      night: ["#193658", "#192B45", "#0F0A20", "#04050A"],
    },
    pouring: {
      day: ["#BFD4E0", "#85A2BB", "#4E6B89", "#2E445F"],
      night: ["#152E4A", "#15253A", "#0D081B", "#040408"],
    },
    lightning: {
      day: ["#B6D0DA", "#789AA6", "#41607A", "#243B54"],
      night: ["#263541", "#0F1932", "#080920", "#01030A"],
    },
    "lightning-rainy": {
      day: ["#B6D0DA", "#789AA6", "#41607A", "#243B54"],
  ...
  const SKY_COLORS = Object.fromEntries(
    Object.entries(SKY_HEX).map(([k, v]) => [
      k,
      { skyDay: v.day.map(_h), skyNight: v.night.map(_h) },
    ]),
  );
  ...
  const WEATHER_VISUALS = Object.freeze({
    ...
    rainy: { engine: "water", rain: 0.7 },
    pouring: { engine: "water", rain: 1.0 },
    lightning: { engine: "water", rain: 1.0, lightning: 1.0 },
    "lightning-rainy": { engine: "water", rain: 1.0, lightning: 1.0 },
  });
  ...
  const AWC_BUILTIN_ICONS = Object.freeze({
    ...
    lightning:
      '<path d="M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973" fill="currentColor" fill-opacity="0.08"/><path d="m13 12-3 5h4l-3 5" stroke-width="1.75"><animate attributeName="stroke-opacity" values="1;1;0.15;1;1;1;0.1;0.8;1;1;1;1;0.12;1" dur="4s" repeatCount="indefinite"/></path>',
    "lightning-rainy":
      '<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" fill="currentColor" fill-opacity="0.06"><animate attributeName="fill-opacity" values="0.06;0.06;0.2;0.06;0.06;0.06;0.15;0.06" dur="3.5s" repeatCount="indefinite"/><animate attributeName="stroke-opacity" values="1;1;0.2;1;1;1;0.15;1" dur="3.5s" repeatCount="indefinite"/></path>',
    partlycloudy:
  ...
  function computeGauge(rawVal, min, max, colorRaw, thresholds, mode) {
    ...
    if (
      ...
      for (let i = 0; i < sorted.length; i++) {
        ...
        const endPct =
          i < sorted.length - 1 ? toPct(sorted[i + 1].value) : "100";
        if (mode === "segments") {
          ...
          if (progress > 0) {
            ...
            const bEnd = (
              (parseFloat(endPct) / (progress * 100)) *
              100
            ).toFixed(1);
  ...
  class AtmosphericWeatherCard extends HTMLElement {
    ...
    setConfig(config) {
      ...
      this._config = config;
      this._areas = this._deriveAreas(this._config);
      ...
      if (String(config.card_height).toLowerCase() === "auto") {
        ...
        const cssHeight =
          typeof heightConfig === "number" ? `${heightConfig}px` : heightConfig;
      ...
      if (this._elements && this._elements.imageSlot) {
        ...
        const scale =
          config.image_scale !== undefined ? config.image_scale : 100;
      ...
      this._simpleBgDark = null;
      if (
        this._config.simple_background !== true &&
        this._elements &&
        this._elements.root
      ) {
      ...
      if (disabled) {
        this._stopAnimation();
      } else if (this._initializationComplete && this._isVisible) {
    ...
    set hass(hass) {
      ...
      const statusObj = cfg.status_entity
        ? hass.states[cfg.status_entity]
        : null;
          ...
          for (const s of allButtons) {
            if (
              ...
              hass.states[s.entity] !==
                (this._refButtonEntities
                  ? this._refButtonEntities.get(s.entity)
                  : undefined)
            ) {
              changed = true;
              break;
            ...
            if (
              ...
              hass.states[s.name_sensor] !==
                (this._refButtonEntities
                  ? this._refButtonEntities.get(s.name_sensor)
                  : undefined)
            ) {
              changed = true;
              break;
            ...
            if (
              ...
              hass.states[s.sub_value_entity] !==
                (this._refButtonEntities
                  ? this._refButtonEntities.get(s.sub_value_entity)
                  : undefined)
            ) {
              changed = true;
              break;
            ...
            for (const ve of condEntities) {
              if (
                hass.states[ve] !==
                (this._refButtonEntities
                  ? this._refButtonEntities.get(ve)
                  : undefined)
              ) {
                changed = true;
                break;
      ...
      const snapshot = {
        ...
        temp:
          wEntity &&
          wEntity.attributes &&
          wEntity.attributes.temperature != null
      ...
      if (weatherState === "exceptional" && isNight)
        weatherState = "clear-night";
      this._weatherState = weatherState;
      this._updateSchemeStyles(isNight, weatherState);
      ...
      this._handleWeatherChange(
        weatherState,
        hasNightChanged || hasDarkChanged,
      );
    }
        ...
        return arr.map((a) => {
          ...
          const buttons = Array.isArray(a.buttons)
            ? a.buttons.map((s) => {
                ...
                c._colorThresholdsSig = JSON.stringify(
                  s.color_thresholds || "",
                );
                return c;
              })
        ...
        .then((unsub) => {
          if (
            ...
            (!this._fcSubs.has(key) &&
              !this._allButtons().some(
                (c) => c.forecast && c.entity === entity,
              ))
          ) {
            unsub();
            return;
    ...
    _resolveFcValue(hass, button, lang) {
      const type = button.forecast === "hourly" ? "hourly" : "daily",
        offset = Math.max(0, parseInt(button.forecast_offset, 10) || 0);
      ...
      let formatted = raw;
      const precision =
        button.forecast_precision !== undefined ? button.forecast_precision : 0;
      const fmt =
    ...
    _evaluateCondition(c, hass) {
      ...
      switch (c.condition) {
        case "state": {
          ...
          if (c.state_not != null) {
            const match = Array.isArray(c.state_not)
              ? c.state_not
              : [c.state_not];
        ...
        case "and": {
          ...
          return c.conditions.every((sub) =>
            this._evaluateCondition(sub, hass),
          );
        }
        case "or": {
          if (!Array.isArray(c.conditions)) return true;
        ...
        case "not": {
          if (!Array.isArray(c.conditions)) return true;
          return c.conditions.every(
            (sub) => !this._evaluateCondition(sub, hass),
          );
        }
        default:
          return true;
    ...
    _checkButtonVisibility(button, hass) {
      return (
        !Array.isArray(button.visibility) ||
        !button.visibility.length ||
        button.visibility.every((c) => this._evaluateCondition(c, hass))
      );
    }
    _checkAreaVisibility(area, hass) {
      return this._checkButtonVisibility(area, hass);
    }
...
`;
    ...
    _initDOM() {
      ...
      if (this._config.card_offset)
        this.style.margin = this._config.card_offset;
    ...
    _syncButtonAreaDOM() {
      ...
      const wanted = this._areas.length,
        current = this._elements.buttonAreaEls;
    ...
    _updateSchemeStyles(isNight, weatherState) {
      ...
      root.classList.toggle(
        "has-sunrays",
        !!vis.sunrays && !isNight && sunEnabled,
      );
    }
    _applyConfigStyles() {
      if (!this._elements || !this._elements.buttonAreaEls.length) return;
      const cfg = this._config;
      const root = this._elements.root;
      this._cssVar(
        root,
    ...
    _applyAreaStyles(ai, area) {
      const els = this._elements.buttonAreaEls[ai];
      if (!els) return;
      const bt = els.row,
        cg = els.group;
      ...
      const bgStyle = ["contrast", "frosted", "theme"].includes(
        (area.background_style || "").toLowerCase(),
      )
        ? area.background_style.toLowerCase()
        : "frosted";
      ...
      if (cache.configSig !== configSig) {
        ...
        bt.style.display = showBottom ? "" : "none";
        cg.style.display = showBottom ? "" : "none";
      }
      ...
      if (cache.visKey !== visKey) {
        ...
        if (hasVis) {
          ...
          bt.style.removeProperty("--awc-button-basis");
          bt.style.removeProperty("--awc-button-basis-v");
        }
...
${sel} > .button:nth-child(-n+${cols})::after { content: none; }`;
    ...
    _updateTextElements(hass, wEntity, lang, weatherState = "default") {
      ...
      for (let ai = 0; ai < this._areas.length; ai++) {
        ...
        const buttonFormat =
          buttonFormatRaw === "stacked"
            ? "stacked"
            : buttonFormatRaw === "vertical"
              ? "vertical"
              : "inline";
        ...
        const visCount = parseInt(area.scroll_count, 10),
          hasVis = Number.isFinite(visCount) && visCount > 0;
        const areaCtx = {
          button_icon_background: area.button_icon_background,
          button_background_color: area.button_background_color || "",
          button_icon_background_color: area.button_icon_background_color || "",
        };
        ...
        const rowButtons = rendered.filter((r) => !r.isFree),
          freeButtons = rendered.filter((r) => r.isFree),
          rowSig = rowButtons.map((r) => r.sig).join("§");
        ...
        if (rowRebuilt) {
          ...
          const hasEnhanced = rowButtons.some(
            (r) =>
        ...
        const freeSig = freeButtons.map((r) => r.sig).join("§"),
          freeRebuilt = ac.lastFreeSig !== freeSig;
        if (freeRebuilt) {
          ac.lastFreeSig = freeSig;
          const tw = this._elements.textWrapper;
          tw.querySelectorAll(`.button-free[data-area="${ai}"]`).forEach((el) =>
            el.remove(),
          );
          for (const r of freeButtons) {
            const wrapper = document.createElement("div");
            wrapper.className = "button-free";
        ...
        const buttonsPos = (area.position || "bottom-left")
          .toString()
          .toLowerCase();
        if (ac.prevPosSig !== buttonsPos) {
          ac.prevPosSig = buttonsPos;
          bt.classList.remove(...POS_CLASSES);
          els.group.classList.remove(...POS_CLASSES);
          bt.classList.add(`pos-${buttonsPos}`);
          els.group.classList.add(`pos-${buttonsPos}`);
          const slot =
            this._elements.posSlots && this._elements.posSlots[buttonsPos];
      ...
      const hasNativeIcons = allRendered.some(
        (r) => r.showIcon && r.iconStrategy === "native",
      );
      if (hasNativeIcons) {
        if (!this._nativeIconCache || anyRowRebuilt || anyFreeRebuilt) {
          const allContainers = [
            ...this._elements.buttonAreaEls.map((e) => e.row),
            ...this._elements.textWrapper.querySelectorAll(".button-free"),
          ];
          ...
          for (let i = 0; i < allRendered.length; i++) {
            ...
            for (const container of allContainers) {
              const iconEl = container.querySelector(
                `.button[data-idx="${r.buttonIdx}"][data-area="${r.areaIdx}"] ha-state-icon`,
              );
              if (iconEl)
                this._nativeIconCache.push({ rendered: r, el: iconEl });
            }
          }
        }
      ...
      if (this._elements && this._elements.customCardsWrapper) {
        const firstAreaPos =
          this._areas.length > 0
            ? (this._areas[0].position || "bottom-left").toLowerCase()
            : "bottom-left";
        ...
        if (this._prevCcSig !== ccSig) {
          ...
          if (ccPos) {
            ...
            const buttonsIsLeft = firstAreaPos.includes("left");
            const buttonsIsRight = firstAreaPos.includes("right");
            ccw.classList.add(
              buttonsIsLeft
                ? "cc-text-right"
                : buttonsIsRight
    ...
    _renderButton(
      ...
      const showIcon = button.hide_icon !== true,
        showLabel = button.hide_label !== true,
        showValue = button.hide_value !== true;
      ...
      if (isForecast) {
        ...
        iconValue = fcCondition
          ...
          : iconValue;
        if (button.attribute && button.attribute !== "condition")
          iconValue = FORECAST_ATTR_ICONS[button.attribute] || iconValue;
      } else {
        ...
        if (sensor) {
          if (button.attribute)
            iconValue =
              WEATHER_ATTR_ICONS[button.attribute] || "mdi:information-outline";
          else {
            sensorObj = sensor;
            iconStrategy = "native";
          }
      ...
      const configIcon = button.icon,
        configPath =
          button.icon_path ||
          (configIcon === "weather" && this._config && this._config.icon_path
            ? this._config.icon_path
            : "");
      if (configIcon) {
        const resolvedBase =
          configIcon === "weather"
        ...
        if (configPath) {
          ...
          if (configIcon === "weather" && AWC_BUILTIN_ICONS[resolvedBase]) {
            ...
            iconValue =
              !isForecast &&
              this._isTimeNight &&
              AWC_BUILTIN_ICONS[`${resolvedBase}-night`]
                ? `${resolvedBase}-night`
                : resolvedBase;
          } else {
            iconStrategy = "static";
      ...
      const hasUnitFormat = button.unit_format !== undefined;
      if (hasUnitFormat) unit = button.unit_format;
      const overflowMode = (button.overflow || "ellipsis")
        .toString()
        .toLowerCase()
        .trim();
      const labelOverflow = (button.label_overflow || "ellipsis")
        .toString()
        .toLowerCase()
        .trim();
      const isValueMarquee = overflowMode === "marquee",
        isLabelMarquee = labelOverflow === "marquee";
      const subOverflow = (button.sub_value_overflow || "ellipsis")
        .toString()
        .toLowerCase()
        .trim();
      ...
      const marqueeRtl = button.marquee_rtl === true,
        width = (button.width || "").toString().trim(),
        height = (button.height || "").toString().trim();
      let name = (button.name || "").toString().trim(),
        nameSig = name;
      ...
      if (button.name_sensor) {
        ...
        if (nRaw != null) {
          if (
            button.name_attribute === "condition" &&
            typeof nRaw === "string"
          ) {
            name =
              (typeof hass.localize === "function" &&
                hass.localize(
                  `component.weather.entity_component._.state.${nRaw}`,
                )) ||
              nRaw;
            if (button.name_format !== undefined)
              name = `${name}${button.name_format}`;
          } else if (
            nRaw !== "" &&
            !isNaN(parseFloat(nRaw)) &&
            isFinite(nRaw)
          ) {
            const _cs = hass.states[button.entity],
              _w = _cs && _cs.attributes;
            const hasNameFormat = button.name_format !== undefined;
            const nUnit = hasNameFormat
              ? button.name_format
              : (_w && _w[`${button.name_attribute}_unit`]) ||
                (_FC_UNIT_MAP[button.name_attribute] &&
                  _w &&
                  _w[_FC_UNIT_MAP[button.name_attribute]]) ||
                _FC_UNIT_FALLBACK[button.name_attribute] ||
                "";
            const _nPrec =
              button.forecast_precision !== undefined
                ...
                : 0;
            const _nFmtFn =
              _nPrec !== undefined && _nPrec !== null
                ? this._getFcFmt(lang, _nPrec)
                : null;
      ...
      if (showSubValue) {
        ...
        if (button.sub_value_entity) {
          const svResolved = this._resolveSensorValue(
            hass,
            button.sub_value_entity,
            button.sub_value_attribute,
          );
          const svUnit = hasSubFormat
            ? button.sub_value_format
            : svResolved.unit;
          ...
          if (svRaw != null) {
            let svFmt = svRaw;
            if (
              button.sub_value_attribute === "condition" &&
              typeof svRaw === "string"
            ) {
              svFmt =
                (typeof hass.localize === "function" &&
                  hass.localize(
                    `component.weather.entity_component._.state.${svRaw}`,
                  )) ||
                svRaw;
            } else if (
              svRaw !== "" &&
              !isNaN(parseFloat(svRaw)) &&
              isFinite(svRaw)
            ) {
              const precision =
                button.forecast_precision !== undefined
            ...
            if (hasSubFormat) {
              ...
              const w = _buttonState && _buttonState.attributes;
              const svUnit =
                (w && w[`${button.sub_value_attribute}_unit`]) ||
                (_FC_UNIT_MAP[button.sub_value_attribute] &&
                  w &&
                  w[_FC_UNIT_MAP[button.sub_value_attribute]]) ||
                _FC_UNIT_FALLBACK[button.sub_value_attribute] ||
                "";
      ...
      if (showIcon) {
        ...
        if (iconStrategy === "native") {
          ...
          const useColored =
            this._config && this._config.icon_set === "colored";
      ...
      const posAnchor = isFree ? button.position_anchor || "top-left" : "",
        posX = isFree ? String(button.position_x || 0).trim() : "0";
      const posY = isFree ? String(button.position_y || 0).trim() : "0";
      const effectiveBg =
        button.background !== undefined ? button.background : rowBg;
      ...
      const iconBg =
        button.icon_background !== undefined
          ? button.icon_background
          : areaCtx.button_icon_background;
      ...
      if (effectiveBg) {
        ...
        iconBg === true ||
        (iconBg !== false && areaCtx.button_icon_background === true)
      ) {
        if (
          bgStyle === "contrast" ||
          bgStyle === "frosted" ||
      ...
      const effectiveBgColor =
        button.background_color || areaCtx.button_background_color || "";
      const effectiveIconBgColor =
        button.icon_background_color ||
        areaCtx.button_icon_background_color ||
        "";
      let buttonTintColor = "";
      if (
        Array.isArray(button.color_thresholds) &&
        button.color_thresholds.length
      ) {
        ...
        if (isForecast && fcEntry) {
          const fca = button.color_threshold_entity
            ? button.color_threshold_attribute
            : ctAttr || button.attribute;
          if (button.color_threshold_entity) {
            const ctr = this._resolveSensorValue(
              hass,
              button.color_threshold_entity,
              button.color_threshold_attribute,
            );
            ctVal = parseFloat(
              ctr.rawNumeric != null ? ctr.rawNumeric : ctr.formatted,
            );
          } else {
        ...
        if (!isNaN(ctVal)) {
          const sorted = [...button.color_thresholds]
            .filter((t) => t.value !== "" && t.value !== undefined && t.color)
            .sort((a, b) => parseFloat(a.value) - parseFloat(b.value));
          for (const t of sorted) {
            if (ctVal >= parseFloat(t.value)) buttonTintColor = t.color;
          }
        }
      }
      const inlineStyles = [];
      ...
      if (buttonTintColor) {
        inlineStyles.push(`--awc-button-tint:${buttonTintColor}`);
        classes.push("has-tint");
      }
      if (button.padding !== undefined && button.padding !== "")
        inlineStyles.push(`padding:${button.padding}`);
      const _wOp = (w) => {
        const n = parseFloat(w);
        if (isNaN(n)) return "";
        return Math.min(
          1,
          Math.max(0.4, 0.4 + ((n - 100) * 0.6) / 800),
        ).toFixed(2);
      };
      for (const [k, v, v2] of [
        ["text_size", "--awc-bottom-font-size"],
        ["label_size", "--awc-button-name-font-size"],
        ["inner_gap", "--awc-button-gap"],
        ["text_gap", "--awc-button-text-gap"],
        ["icon_size", "--awc-icon-size"],
        ["icon_padding", "--awc-icon-padding"],
        [
          "value_weight",
          "--awc-button-value-weight",
          "--awc-stacked-value-weight",
        ],
        ["label_weight", "--awc-button-name-weight"],
        ["sub_value_size", "--awc-sub-size"],
        ["sub_value_weight", "--awc-sub-weight"],
      ]) {
        if (button[k]) {
          inlineStyles.push(`${v}:${button[k]}`);
          if (v2) inlineStyles.push(`${v2}:${button[k]}`);
        }
      }
      if (button.label_weight) {
        const o = _wOp(button.label_weight);
        if (o) {
          inlineStyles.push(`--awc-button-name-opacity:${o}`);
          inlineStyles.push(`--awc-stacked-name-opacity:${o}`);
        }
      }
      if (button.value_weight) {
        const o = _wOp(button.value_weight);
        if (o) inlineStyles.push(`--awc-button-value-opacity:${o}`);
      }
      if (button.sub_value_weight) {
        const o = _wOp(button.sub_value_weight);
        if (o) inlineStyles.push(`--awc-sub-opacity:${o}`);
      }
      if (button.text_size) inlineStyles.push(`font-size:${button.text_size}`);
      if (button.text_shadow === true)
        inlineStyles.push("--_button-no-bg-shadow:var(--_button-shadow-avail)");
      ...
      let ringHtml = "",
        ...
        barHtml = "";
      if (isRingType) {
        const ringMin = parseFloat(button.ring_min) || 0,
          ringMax = parseFloat(button.ring_max) || 100;
        const ringW = parseFloat(button.ring_width) || 4,
          ringGap = parseFloat(button.ring_gap) || 3;
        const g = computeGauge(
          gaugeVal,
          ringMin,
          ringMax,
          (button.ring_color || "").trim(),
          Array.isArray(button.ring_thresholds) ? button.ring_thresholds : [],
          button.ring_threshold_mode || "solid",
        );
      ...
      if (isBarType) {
        const barMin = parseFloat(button.bar_min) || 0,
          barMax = parseFloat(button.bar_max) || 100;
        const barH = parseFloat(button.bar_height) || 4;
        const g = computeGauge(
          gaugeVal,
          barMin,
          barMax,
          (button.bar_color || "").trim(),
          Array.isArray(button.bar_thresholds) ? button.bar_thresholds : [],
          button.bar_threshold_mode || "solid",
        );
      ...
      const loaderHtml = fcLoading
        ? '<div class="button-loader"><span></span><span></span><span></span></div>'
        : "";
      ...
      if (elOrder && elOrder.length >= 2) {
        ...
        if (textIdx >= 0) contentOrder = ` style="order:${textIdx}"`;
          ...
          const textEls = [
            elOrder.indexOf("label"),
            elOrder.indexOf("value"),
            elOrder.indexOf("sub"),
          ].filter((i) => i >= 0);
          if (textEls.length)
            contentOrder = ` style="order:${Math.min(...textEls)}"`;
        }
        if (barIdx >= 0) barOrder = ` style="order:${barIdx}"`;
      }
      let txtOrder = button.text_order
        ? button.text_order
            .toString()
            .split(",")
            .map((s) => s.trim().toLowerCase())
      ...
      if (!txtOrder && elOrder) {
        const legacyTxts = ["label", "value", "sub"].filter(
          (t) => elOrder.indexOf(t) >= 0,
        );
      ...
      const nameHtmlOrdered = nameHtml
        ? nameHtml.replace(
            '<span class="button-name',
            `<span${nameOrder} class="button-name`,
          )
        : "";
      const valHtmlOrdered = valHtml
        ? valHtml.replace(
            '<span class="button-val',
            `<span${valOrder} class="button-val`,
          )
        : "";
      const subHtmlOrdered = subBelowHtml
        ? subOrder
          ? subBelowHtml.replace(
              '<span class="button-sub',
              `<span${subOrder} class="button-sub`,
            )
          : subBelowHtml
        : "";
      const contentHtml =
        nameHtmlOrdered || valHtmlOrdered || subHtmlOrdered
          ? `<span class="button-content"${contentOrder}>${nameHtmlOrdered}${valHtmlOrdered}${subHtmlOrdered}</span>`
          : "";
      const iconHtmlOrdered =
        iconHtml && iconOrder
          ? iconHtml.replace(
              '<span class="button-icon',
              `<span${iconOrder} class="button-icon`,
            )
          : iconHtml || "";
      const barHtmlOrdered =
        barHtml && barOrder
          ? barHtml.replace(
              'class="button-bar" style="',
              `class="button-bar" style="order:${elOrder.indexOf("bar")};`,
            )
          : barHtml || "";
      ...
      const sig = [
        ...
        buttonAlignClass,
        subValueSig,
        _n(button.sub_value_format),
        button.sub_value_size || "",
        button.sub_value_weight || "",
        button.sub_value_overflow || "",
        button.hide_sub_value || "",
        useFancyUnit,
        button.value_weight || "",
        button.label_weight || "",
        button.button_round || "",
        ...
        button.ring_width || "",
        button.ring_gap || "",
        button.ring_threshold_mode || "",
        button._ringThresholdsSig || "",
        _n(button.bar_min),
        _n(button.bar_max),
        button.bar_color || "",
        button.bar_height || "",
        button.bar_threshold_mode || "",
        button._barThresholdsSig || "",
        gaugeSig,
        buttonTintColor,
        button.element_order || "",
        button.text_order || "",
    ...
    _updateImage(hass, isNight, weatherState = "default") {
      if (!this._elements || !this._elements.imageSlot) return;
      const img = this._elements.img;
      const slot = this._elements.imageSlot;
      const statusSrc = this._calculateStatusImage(hass, isNight);
      const baseSrc = isNight
        ? this._config.image_night
        : this._config.image_day;
    ...
    _refreshMarqueeObservation() {
      ...
      for (const els of (this._elements && this._elements.buttonAreaEls) ||
        ...
        if (els.row) {
          els.row
            .querySelectorAll(".button.overflow-marquee")
            .forEach((button) => this._marqueeObserver.observe(button));
        }
      }
      const tw = this._elements && this._elements.textWrapper;
      if (tw) {
        tw.querySelectorAll(".button-free .button.overflow-marquee").forEach(
          (button) => this._marqueeObserver.observe(button),
        );
      }
    }
    ...
    _computeVerticalVisHeight(areaIdx) {
      const els =
        this._elements &&
        this._elements.buttonAreaEls &&
        this._elements.buttonAreaEls[areaIdx];
      ...
      bt.style.setProperty(
        "--awc-row-max-height",
        `${firstButton.offsetHeight * visCount + gap * (visCount - 1)}px`,
      );
    }
        ...
        new CustomEvent("hass-action", {
          ...
          detail: {
            config: {
              ...
              tap_action: cfg.card_tap_action,
            },
            action: "tap",
          },
        }),
    ...
    _handleButtonClick(e) {
      ...
      const area = this._areas && this._areas[areaIdx];
      if (!area) return;
      const button = area.buttons && area.buttons[idx];
      ...
      this.dispatchEvent(
        new CustomEvent("hass-action", {
          ...
          composed: true,
          detail: {
            config: { entity: button.entity, tap_action: tapAction },
            action: "tap",
          },
        }),
      );
    ...
    _tryInitialize() {
      ...
      if (!this._cachedDimensions.width || !this._cachedDimensions.height)
        return;
    ...
    _updateCanvasDimensions(forceW = null, forceH = null) {
      ...
      let scaledWidth = Math.floor(rawW * dpr),
        scaledHeight = Math.floor(rawH * dpr);
    ...
    _bakeStarLayers(baseCount = 1000) {
      ...
      const rng = () => {
        s0 = (s0 * 16807 + 0) % 2147483647;
        return (s0 & 0x7fffffff) / 0x7fffffff;
      };
      const sbg = this._elements && this._elements.starBgCanvas;
      ...
      const bgCtx =
        this._starBgCtx ||
        (this._starBgCtx = sbg.getContext("2d", { alpha: true }));
      if (!bgCtx) return;
      ...
      if (mwActive) {
        ...
        mwCosA = Math.cos(mAngle);
        mwSinA = Math.sin(mAngle);
        mwPerpX = -mwSinA;
        mwPerpY = mwCosA;
        mwBandW = H * 0.18;
      ...
      for (let i = 0; i < tinyCount; i++) {
        ...
        if (mwActive && i % 3 === 0) {
          const bx =
            mwCx +
            mwCosA * ((x / W - 0.5) * W * 1.2) +
            mwPerpX * ((y / H - 0.5) * mwBandW);
          const by =
            mwCy +
            mwSinA * ((x / W - 0.5) * W * 1.2) +
            mwPerpY * ((y / H - 0.5) * mwBandW);
      ...
      for (let i = 0; i < smallCount; i++) {
        ...
        if (mwActive && i % 3 === 0) {
          const bx =
            mwCx +
            mwCosA * ((x / W - 0.5) * W * 1.2) +
            mwPerpX * ((y / H - 0.5) * mwBandW * 0.8);
          const by =
            mwCy +
            mwSinA * ((x / W - 0.5) * W * 1.2) +
            mwPerpY * ((y / H - 0.5) * mwBandW * 0.8);
          if (bx >= 0 && bx <= W && by >= 0 && by <= H) {
            x = bx;
            y = by;
          }
      ...
      for (let c = 0; c < clusterCount; c++) {
        ...
        for (let j = 0; j < count; j++) {
          ...
          if (j % 8 === 0) r *= 1.8;
          r = Math.min(r, 2.5);
          addToBatch(palettes[1], 0.3 + rng() * 0.2, x, y, r);
        }
      }
      ...
      for (let i = 0; i < HERO_COUNT; i++) {
        const isFeature = i < 2;
        const size = Math.min(
          isFeature ? 1.8 + rng() * 0.4 : 1.3 + rng() * 0.4,
          1.8,
        );
        ...
        const hc = useOC
          ? new OffscreenCanvas(texPx, texPx)
        ...
        const haloA = isFeature ? 0.6 : 0.35;
        ...
        hg.addColorStop(
          0.15,
          `rgba(${rgb[0]},${rgb[1]},${rgb[2]},${(haloA * 0.8).toFixed(3)})`,
        );
        hg.addColorStop(
          0.4,
          `rgba(${rgb[0]},${rgb[1]},${rgb[2]},${(haloA * 0.25).toFixed(3)})`,
        );
        ...
        if (isFeature) {
          ...
          for (let r = 0; r < 4; r++) {
            ...
            rg.addColorStop(
              0.15,
              `rgba(${rgb[0]},${rgb[1]},${rgb[2]},${(haloA * 0.7).toFixed(3)})`,
            );
            rg.addColorStop(
              0.5,
              `rgba(${rgb[0]},${rgb[1]},${rgb[2]},${(haloA * 0.2).toFixed(3)})`,
            );
            ...
            rg2.addColorStop(
              0,
              `rgba(255,255,255,${(haloA * 0.9).toFixed(3)})`,
            );
            rg2.addColorStop(
              0.15,
              `rgba(${rgb[0]},${rgb[1]},${rgb[2]},${(haloA * 0.7).toFixed(3)})`,
    ...
    _updateStars(sunEntity, weatherState) {
      ...
      if (this._starMasterOpacity !== vis.starsOpacity)
        this._starBgPainted = false;
    ...
    _renderStars(timestamp) {
      ...
      if (!sc || this._starMasterOpacity <= 0) {
        if (this._starsDirty && sc && sc.width > 0) {
          const ctx =
            this._starCtx ||
            (this._starCtx = sc.getContext("2d", { alpha: true }));
      ...
      const ctx =
        this._starCtx || (this._starCtx = sc.getContext("2d", { alpha: true }));
      if (!ctx) return;
      const cw = sc.width;
      const ch = sc.height;
      ...
      for (let i = 0; i < heroes.length; i++) {
        ...
        const twinkle =
          Math.sin(h.phase) +
          Math.sin(h.phase * 2.7) * 0.5 +
          Math.sin(h.phase * 0.4) * 0.3;
        const size = h.size * (1 + twinkle * 0.35);
        const op =
          Math.min(1, Math.max(0, h.brightness * (1 + twinkle * 0.4))) * master;
        if (op < 0.05) continue;
        const px = h.x * cssW;
        const py = h.y * cssH;
        if (h.haloTex) {
    ...
    _drawShootingStars(ctx, w, h) {
      const m = this._starMasterOpacity,
        S = this._shootingStars,
        K = this._comets;
      if (Math.random() < 0.00429 && S.length < 2) {
        ...
        const dx = Math.random() < 0.3 ? -1 : 1,
          bl = Math.random() < 0.18;
        const sp = bl ? 3.5 + Math.random() * 2 : 5 + Math.random() * 5,
          cr = Math.random();
        const [hr, tr] =
          cr < 0.55
            ? ["rgb(255,255,255)", "rgb(255,255,240)"]
            : cr < 0.75
              ? ["rgb(255,245,210)", "rgb(255,230,180)"]
              : cr < 0.92
                ? ["rgb(210,255,225)", "rgb(180,240,200)"]
        ...
        S.push({
          ...
          life: 1,
          dc: bl ? 0.032 : 0.045,
          sz: bl ? 2.5 + Math.random() * 1.5 : 1.5 + Math.random() * 1.5,
          bl,
          hr,
          tr,
          tb: new Float32Array(44),
          th: 0,
          tl: 0,
        });
      }
      ...
      for (let i = S.length - 1; i >= 0; i--) {
        ...
        ctx.beginPath();
        ctx.arc(s.x, s.y, hs, 0, 6.2832);
        ctx.fill();
        ctx.lineWidth = hs * 0.8;
        ...
        for (let b = 0; b < 4; b++) {
          const j0 = (b * segs) >> 2,
            j1 = ((b + 1) * segs) >> 2;
          if (j0 >= j1) continue;
          ctx.globalAlpha = op * (1 - ((j0 + j1) * 0.5) / s.tl);
          ctx.beginPath();
          for (let j = j0; j <= j1; j++) {
            const idx = (((s.th - 1 - j) % 22) + 22) % 22;
            j === j0
              ? ctx.moveTo(s.tb[idx * 2], s.tb[idx * 2 + 1])
              : ctx.lineTo(s.tb[idx * 2], s.tb[idx * 2 + 1]);
          }
          ctx.stroke();
        }
      }
      if (!K.length && Math.random() < 0.0005456) {
        const sx = Math.random() < 0.5 ? -60 : w + 60,
          dir = sx < 0 ? 1 : -1,
          sp = 2.2 + Math.random() * 1.3,
          cr = Math.random();
        const [co, gl, tr] =
          cr < 0.5
            ? ["220,240,255", "100,200,255", "rgb(160,210,255)"]
            : cr < 0.78
              ? ["200,255,220", "120,220,160", "rgb(150,230,180)"]
      ...
      for (let i = K.length - 1; i >= 0; i--) {
        ...
        if (c.tl < 100) c.tl++;
        if (c.tl > 2) {
          const ni = (((c.th - 1) % 100) + 100) % 100,
            oi = (((c.th - c.tl) % 100) + 100) % 100;
          const dx = c.tb[ni * 2] - c.tb[oi * 2],
            dy = c.tb[ni * 2 + 1] - c.tb[oi * 2 + 1];
        ...
        if (!c._g) {
          ...
          g.addColorStop(0, `rgba(${c.co},1)`);
          g.addColorStop(0.4, `rgba(${c.gl},0.4)`);
          g.addColorStop(1, `rgba(${c.gl},0)`);
          c._g = g;
        }
        ctx.globalAlpha = op;
        ctx.save();
        ...
        ctx.fillStyle = c._g;
        ctx.beginPath();
        ctx.arc(0, 0, c.sz * 4, 0, 6.2832);
        ctx.fill();
        ctx.restore();
        ctx.lineCap = "butt";
        ctx.strokeStyle = c.tr;
        const segs = c.tl - 1;
        for (let b = 0; b < 8; b++) {
          const j0 = ((b * segs) / 8) | 0,
            j1 = (((b + 1) * segs) / 8) | 0;
          if (j0 >= j1) continue;
          const mp = ((j0 + j1) * 0.5) / c.tl;
          ctx.lineWidth = c.sz * (1 - mp * 0.8);
          ctx.globalAlpha = op * (1 - mp) * 0.6;
          ctx.beginPath();
          for (let j = j0; j <= j1; j++) {
            const idx = (((c.th - 1 - j) % 100) + 100) % 100;
            j === j0
              ? ctx.moveTo(c.tb[idx * 2], c.tb[idx * 2 + 1])
              : ctx.lineTo(c.tb[idx * 2], c.tb[idx * 2 + 1]);
          }
          ctx.stroke();
        }
      }
...
void main(){
    ...
    _initWebGL() {
      ...
      if (!gl || gl.isContextLost()) {
        console.warn("AWC: WebGL2 not available");
        this._applyShaderDisabledState(true);
        return;
      }
      this._gl = gl;
      ...
      const needed = this._shaderParams
        ? this._shaderParams.shader || "sky"
        : "sky";
      const shaders = [{ key: "sky", frag: this._glslFrag() }];
      if (needed !== "sky")
        shaders.push({ key: needed, frag: this._glslFragFor(needed) });
    ...
    _pollShaderCompile(gl, compiled, ext) {
      ...
      const poll = () => {
        if (!this.isConnected) return;
        const allDone = compiled.every(
          (c) =>
            gl.getShaderParameter(c.vs, COMPLETION) &&
            gl.getShaderParameter(c.fs, COMPLETION),
        );
        if (allDone) {
          this._finalizeShaders(gl, compiled);
        } else {
    ...
    _buildProgram(gl, key, vs, fs) {
      if (!gl.getShaderParameter(vs, gl.COMPILE_STATUS)) {
        console.error(`AWC ${key} vertex:`, gl.getShaderInfoLog(vs));
        gl.deleteShader(vs);
        gl.deleteShader(fs);
        return null;
      }
      if (!gl.getShaderParameter(fs, gl.COMPILE_STATUS)) {
        console.error(`AWC ${key} fragment:`, gl.getShaderInfoLog(fs));
        gl.deleteShader(vs);
        gl.deleteShader(fs);
        return null;
      }
      ...
      if (!gl.getProgramParameter(prog, gl.LINK_STATUS)) {
        console.error(`AWC ${key} link:`, gl.getProgramInfoLog(prog));
    ...
    _weatherToUniforms() {
      const key = WEATHER_VISUALS[this._weatherState]
        ? this._weatherState
        : "default";
      ...
      const fxSpeed =
        vis.engine === "water" ? 0.4 + vis.rain * 0.9 : vis.cloudSpeed;
      const program =
        vis.engine === "water" ? "water" : vis.snowfall > 0 ? "snow" : "sky";
      ...
      if (
        ...
        p.wind === wind &&
        p.fxSpeed === fxSpeed &&
        p.cloudDensity === vis.cloudCover &&
        p.cloudShade === vis.cloudShadow &&
        p.cloudBase === vis.cloudThickness &&
        p.cloudSize === vis.cloudScale &&
        p.cloudGap === vis.clearing &&
        p.rainIntensity === vis.rain &&
        p.density === vis.snowfall &&
        p.grain === vis.flakeSize &&
        p.hail === vis.hail &&
        p.lightning === vis.lightning &&
        p.skyColors === skyColors
      )
        return p;
      return {
        shader: program,
        ...
        wind,
        fxSpeed,
        cloudDensity: vis.cloudCover,
        cloudShade: vis.cloudShadow,
        cloudBase: vis.cloudThickness,
        cloudSize: vis.cloudScale,
        cloudGap: vis.clearing,
    ...
    _renderShader(timestamp) {
      ...
      if (targetKey !== this._activeShaderKey && this._shaderBank) {
        if (
          !this._shaderBank[targetKey] &&
          this._gl &&
          this._vertSrc &&
          targetKey !== "sky"
        ) {
          const vs = gl.createShader(gl.VERTEX_SHADER);
          gl.shaderSource(vs, this._vertSrc);
          gl.compileShader(vs);
          const fs = gl.createShader(gl.FRAGMENT_SHADER);
          gl.shaderSource(fs, this._glslFragFor(targetKey));
          gl.compileShader(fs);
      ...
      if (u.u_ref_height != null)
        gl.uniform1f(u.u_ref_height, 300.0 * (this._cachedDimensions.dpr || 1));
      if (s !== this._prevShaderParams) {
        gl.uniform1f(u.u_dark, s.dark);
        if (u.u_wind != null) gl.uniform1f(u.u_wind, s.wind);
        if (u.u_cloud_density != null)
          gl.uniform1f(u.u_cloud_density, s.cloudDensity);
        if (u.u_cloud_shade != null)
          gl.uniform1f(u.u_cloud_shade, s.cloudShade);
        ...
        if (u.u_rain_intensity != null)
          gl.uniform1f(u.u_rain_intensity, s.rainIntensity);
      ...
      if (fxSpeed !== this._prevFxSpeed) {
        if (u.u_fx_speed != null) gl.uniform1f(u.u_fx_speed, fxSpeed);
        this._prevFxSpeed = fxSpeed;
      }
  ...
  if (!customElements.get(CARD_NAME)) {
    ...
    window.customCards.push({
      ...
      description: "A detail-oriented Home Assistant Weather Card",
    });
  } else {
    console.info(
      `%c ${CARD_NAME} already defined`,
